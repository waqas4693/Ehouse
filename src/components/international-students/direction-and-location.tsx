...
function serviceLocationDetails(locationName: string, locationAddress: string, locationPhone: string, locationWebsite: string): ServiceLocationDetails {
    return { locationName, locationAddress, locationPhone, locationWebsite };
}
...
function serviceData(serviceName: string, serviceDescription: string, serviceLocationDetails: ServiceLocationDetails[]): ServiceData {
...
const citizenAdviceService = serviceData('Citizen Advice Bureau', 'CITIZEN ADVICE BUREAU AROUND US', citizenAdviceDetails);
